    ...
    function parserSetting() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function (item) {
                ...
                setTimeout(function () {
                    var targetAnchor = $('div[data-name="jackett_key"]').first();
                    if (targetAnchor.length) item.insertAfter(targetAnchor);
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function (item) {
                ...
                setTimeout(function () {
                    var targetAnchor = $('div[data-name="jackett_key_two"]').first();
                    if (targetAnchor.length) item.insertAfter(targetAnchor);
                    if (Lampa.Storage.field('parser_use')) item.show();
                    else item.hide();
                });
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function (item) {
                setTimeout(function () {
                    var manage = $('div[data-name="lme_parser_manage_secondary"]').first();
